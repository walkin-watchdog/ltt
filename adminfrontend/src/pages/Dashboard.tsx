      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-3">
            ...
            <button className="w-full text-left p-3 hover:bg-gray-50 rounded-lg flex items-center justify-between">
              <span className="text-gray-700">View Recent Bookings</span>
              <ArrowUpRight className="h-4 w-4 text-gray-400" />
            </button>
            <button className="w-full text-left p-3 hover:bg-gray-50 rounded-lg flex items-center justify-between">
              <span className="text-gray-700">Check Trip Requests</span>
              <ArrowUpRight className="h-4 w-4 text-gray-400" />
            </button>
            <button className="w-full text-left p-3 hover:bg-gray-50 rounded-lg flex items-center justify-between">
              <span className="text-gray-700">Review Abandoned Carts</span>
              <ArrowUpRight className="h-4 w-4 text-gray-400" />
            </button>
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center p-3 border-l-4 border-orange-500 bg-orange-50">
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">Trip request submitted</p>
              <p className="text-xs text-gray-500">3 hours ago</p>
            </div>
          </div>
          <div className="flex items-center p-3 border-l-4 border-yellow-500 bg-yellow-50">
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">Abandoned cart reminder sent</p>
