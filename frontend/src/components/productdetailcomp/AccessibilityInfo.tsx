...
import { Baby, Heart, Train, CheckCircle, XCircle, Users, Shield } from "lucide-react";
 ...
 export const AccessibilityInfo = () => {
    ...
    const getAccessibilityIcon = (type: string) => {
        switch (type) {
            case 'wheelchair': return <Users className="h-5 w-5" />;
                                    ...
                                    <div className="mt-6 pt-6 border-t border-purple-200">
                                        <div className="flex items-center justify-between p-4 bg-white rounded-xl shadow-sm border border-gray-200">
                                            <div className="flex items-center space-x-3">
                                                ...
                                                <span className="text-sm font-medium text-gray-700">Physical Difficulty</span>
                                            </div>
                                            <span className={`text-sm font-bold px-3 py-1.5 rounded-full shadow-sm ${
                                                currentProduct.difficulty === 'Easy' ? 'bg-green-100 text-green-800 border border-green-200' :
                                                currentProduct.difficulty === 'Moderate' ? 'bg-yellow-100 text-yellow-800 border border-yellow-200' :
                                                currentProduct.difficulty === 'Challenging' ? 'bg-red-100 text-red-800 border border-red-200' :
