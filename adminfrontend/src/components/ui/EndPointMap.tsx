...
export const EndPointMap = ({ endPoints = [], onEndPointsChange }: EndPointMapProps) => {
  ...
  // Initialize autocomplete when adding/editing
  useEffect(() => {
    if (isLoaded && inputRef.current && isAddingEndPoint) {
      initializeAutocomplete();
    }
    return () => {
      cleanupAutocomplete();
    };
  }, [isLoaded, isAddingEndPoint]);
  ...
  const onPlaceChanged = () => {
    ...
    if (place.geometry?.location) {
      ...
      // Clear search value and reinitialize
      setSearchValue('');
      if (inputRef.current) {
      ...
      <div className="flex items-center justify-between">
        ...
        {!isAddingEndPoint && (
          <button
            ...
            className="flex items-center px-3 py-2 bg-[#ff914d] text-white rounded-md hover:bg-[#e8823d] transition-colors text-sm"
          >
            ...
            <div>
              ...
              {!isLoaded && (
                <div className="text-xs text-gray-500 mt-1">
                  <div className="inline-block animate-spin rounded-full h-3 w-3 border-b border-[#ff914d] mr-1"></div>
                  Loading Google Maps...
                </div>
              )}
            </div>
              ...
              <>
                ...
                <div className="flex justify-end space-x-2">
                  ...
                  <button
                    ...
                    className="px-3 py-2 bg-[#ff914d] text-white rounded-md hover:bg-[#e8823d] transition-colors text-sm"
                  >
