      ...
      {filteredCoupons.length === 0 ? (
        <div className="text-center py-12 bg-white rounded-lg shadow-sm">
          ...
          {(user?.role === 'ADMIN' || user?.role === 'EDITOR') && (
            <button
              onClick={handleAddCoupon}
              className="bg-[#ff914d] text-white px-4 py-2 rounded-lg hover:bg-[#e8823d] transition-colors inline-flex items-center"
            >
              <Plus className="h-4 w-4 mr-2" />
                ...
                <div className="flex justify-between items-center mt-4 pt-4 border-t border-gray-100">
                  <div className="flex space-x-1">
                    ...
                    <button
                      ...
                      className="p-2 text-gray-400 hover:text-[#104c57] transition-colors"
                  ...
                  <div className="flex items-center">
                    <label className="relative inline-flex items-center cursor-pointer">
                      ...
                      <div className={`w-11 h-6 ${
                        coupon.isActive ? 'bg-[#ff914d]' : 'bg-gray-200'
              ...
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#ff914d] ${
                        ...
                        <button
                          ...
                          className={`flex items-center justify-center border rounded-md p-3 ${
                            formData.type === 'PERCENTAGE'
                              ...
                              : 'border-gray-300 hover:border-[#ff914d]'
                          }`}
                        >
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`w-full ${formData.type === 'PERCENTAGE' ? 'pr-8' : 'pl-8'} px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#ff914d] ${
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`w-full pl-8 px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#ff914d] ${
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="flex items-center justify-between">
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      ...
                      } rounded-full peer peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#ff914d]/20 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all`}></div>
                ...
                <div className="flex justify-end space-x-3">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-[#ff914d] text-white rounded-md hover:bg-[#e8823d] disabled:opacity-50"
                  >
                        ...
                        {usageDetails.map((usage, index) => (
                          <tr key={index} className="hover:bg-gray-50">
                            ...
                            <td className="px-4 py-2 whitespace-nowrap text-sm">
                              <a href={`/bookings/${usage.bookingId}`} className="text-[#ff914d] hover:underline">
                                {usage.bookingCode}
                              </a>
                            </td>
