      ...
      <div className="min-h-screen bg-gradient-to-br from-[#104c57] to-[#ff914d] flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white rounded-lg shadow-xl p-8">
          ...
          <div className="text-center">
            <Link
              to="/forgot-password"
              className="bg-[#ff914d] text-white px-4 py-2 rounded-lg hover:bg-[#e8823d] transition-colors inline-block"
            >
            ...
            <div className="mt-4">
              <Link
                to="/login"
                className="text-[#104c57] hover:text-[#ff914d] transition-colors"
              >
                Return to login
              </Link>
            </div>
        ...
        {resetComplete ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-[#ff914d] text-white py-3 px-4 rounded-lg font-medium hover:bg-[#e8823d] focus:outline-none focus:ring-2 focus:ring-[#ff914d] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center"
            >
              {isSubmitting ? (
            ...
            <div className="text-center">
              <Link
                to="/login"
                className="flex items-center justify-center text-[#104c57] hover:text-[#ff914d] transition-colors"
              >
