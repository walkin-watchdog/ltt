                  ...
                  <tr key={user.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="flex-shrink-0 h-10 w-10 rounded-full bg-gradient-to-br from-[#ff914d] to-[#e8823d] flex items-center justify-center">
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#ff914d] ${
