    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        {(user?.role === 'ADMIN' || user?.role === 'EDITOR') && (
          <Link
            to="/products/new"
            className="bg-[#ff914d] text-white px-4 py-2 rounded-lg hover:bg-[#e8823d] transition-colors flex items-center"
          >
            ...
            <div className="relative h-48">
              ...
              {product.discountPrice && (
                <div className="absolute top-3 right-3">
                  <span className="bg-[#ff914d] text-white px-2 py-1 text-xs font-semibold rounded-full">
                    Special Offer
                  </span>
                </div>
              )}
